(function (a, b) {
    ...
    f.extend({
        ...
        a.setAttribute("className", "t"), a.innerHTML = " <link/><table></table><a href='http://www.sogouhb.com/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = a.getElementsByTagName("*"), e = a.getElementsByTagName("a")[0];
        if (!d || !d.length || !e)
            return {};
...
(function () {
    jQuery.noConflict();
    jQuery('#slideshow').skitter({ width: 1200, height: 280, animation: 'random', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a target="_blank" href="../index.htm" ><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 3000, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
})();
